    ...
    <AnimatePresence>
      {open && slide && (
        ...
        >
          ...
          {/* Stage */}
          <div className="flex-1 grid place-items-center px-4 sm:px-10 pb-4">
          ...
          {/* Controls */}
          <div className="flex items-center justify-center gap-4 pb-5 text-white">
            <button onClick={prev} disabled={i === 0}
              className="p-3 rounded-full bg-white/10 hover:bg-white/20 disabled:opacity-30">
              <ChevronLeft className="w-5 h-5" />
            </button>
            <div className="text-sm tabular-nums">{i + 1} / {slides.length}</div>
