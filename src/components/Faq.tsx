...
const FAQS = [
  { q: "How does Slide Sphere generate presentations?", a: "Slide Sphere uses advanced AI models to draft a coherent narrative, structure, and copy from a single prompt — then assembles it into editable slides with tasteful layouts and typography." },
  { q: "Can I upload my own documents?", a: "Yes. Upload a PDF, JPG, or JPEG and Slide Sphere will use it as source material to generate an on-topic, on-brand deck." },
    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground">Everything you need to know about Slide Sphere.</p>
        </div>
