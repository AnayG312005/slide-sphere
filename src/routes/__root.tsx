...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Generate beautiful, on-brand presentations from a single prompt. Slide Sphere turns ideas into polished slide decks instantly." },
      { property: "og:title", content: "Slide Sphere— AI-powered slide generator" },
      { property: "og:description", content: "Generate beautiful, on-brand presentations from a single prompt. Slide Sphere turns ideas into polished slide decks instantly." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Slide Sphere— AI-powered slide generator" },
      { name: "twitter:description", content: "Generate beautiful, on-brand presentations from a single prompt. Slide Sphere turns ideas into polished slide decks instantly." },
