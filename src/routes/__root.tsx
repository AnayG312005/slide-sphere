...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lumen — AI-powered slide decks in seconds" },
      ...
      { property: "og:title", content: "Lumen — AI-powered slide decks" },
      { property: "og:description", content: "Generate beautiful presentations from a single prompt." },
